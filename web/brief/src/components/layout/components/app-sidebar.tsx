    ...
    >
      <SidebarContent className='py-4'>
        <AnimatePresence mode='wait' initial={false}>
          <motion.div
            key={key}
            initial={shouldReduce ? false : MOTION_VARIANTS.sidebarSlide.initial}
      ...
      <SidebarFooter className='border-t border-slate-200 px-4 py-3 text-xs text-slate-400'>
        copyright@2025 DD Tokens
      </SidebarFooter>
