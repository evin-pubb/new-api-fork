...
export function SystemBrand(props: SystemBrandProps) {
  ...
  const name = props.defaultName || 'DD Tokens'
  const logo = '/logo.png'
  ...
  if (variant === 'inline') {
    return (
      <Link
        ...
        className={cn(
          'text-slate-800 inline-flex h-10 items-center gap-2 rounded-md px-1.5 text-[17px] font-semibold transition-colors outline-none select-none',
  ...
  return (
    <SidebarMenu>
      <SidebarMenuItem>
        <SidebarMenuButton
          size='lg'
          className='h-16 cursor-default gap-2 rounded-none px-3 hover:bg-transparent active:bg-transparent group-data-[collapsible=icon]:px-2'
          render={<div />}
        >
