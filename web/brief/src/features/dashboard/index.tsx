...
function DashboardModelAnalytics(props: {
  isAdmin: boolean
  modelFilters: DashboardFilters
      ...
      <FadeIn delay={0.1}>
        <Suspense fallback={<ModelChartsFallback />}>
          <LazyConsumptionDistributionChart
            ...
            defaultChartType={
              props.chartPreferences.consumptionDistributionChart
            }
            timeGranularity={
              props.modelFilters.time_granularity || DEFAULT_TIME_GRANULARITY
            }
          />
        </Suspense>
      </FadeIn>
      <FadeIn delay={0.15}>
        <Suspense fallback={<ModelChartsFallback />}>
          <LazyModelCharts
            data={props.modelData}
            loading={props.dataLoading}
            defaultChartTab={props.chartPreferences.modelAnalyticsChart}
            timeGranularity={
              props.modelFilters.time_granularity || DEFAULT_TIME_GRANULARITY
            }
          />
    ...
    <SectionPageLayout>
      ...
      <SectionPageLayout.Content>
        <div className='space-y-3 sm:space-y-4'>
          ...
          {activeSection === 'overview' && (
            <OverviewDashboard
              modelAnalyticsActions={modelActions}
              modelAnalytics={
                <DashboardModelAnalytics
                  isAdmin={isAdmin}
