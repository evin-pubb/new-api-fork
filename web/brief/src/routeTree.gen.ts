...
import { Route as AuthenticatedDocsIntegrationRouteImport } from './routes/_authenticated/docs/integration'
...
const AuthenticatedDocsIntegrationRoute =
  AuthenticatedDocsIntegrationRouteImport.update({
    id: '/docs/integration',
...
export interface FileRoutesByFullPath {
  ...
  '/docs/integration': typeof AuthenticatedDocsIntegrationRoute
...
export interface FileRoutesById {
  ...
  '/_authenticated/docs/integration': typeof AuthenticatedDocsIntegrationRoute
...
export interface FileRouteTypes {
  ...
  id:
    ...
    | '/_authenticated/docs/integration'
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/docs/integration': {
      id: '/_authenticated/docs/integration'
      path: '/docs/integration'
      fullPath: '/docs/integration'
      preLoaderRoute: typeof AuthenticatedDocsIntegrationRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/_authenticated/dashboard/$section': {
...
interface AuthenticatedRouteRouteChildren {
  ...
  AuthenticatedDocsIntegrationRoute: typeof AuthenticatedDocsIntegrationRoute
...
const AuthenticatedRouteRouteChildren: AuthenticatedRouteRouteChildren = {
  ...
  AuthenticatedDocsIntegrationRoute: AuthenticatedDocsIntegrationRoute,
